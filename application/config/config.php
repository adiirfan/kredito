...
$config['email_footer'] = "<BR><BR><BR>".
            ...
            "<BR>".
            "<a target='_blank' style='font-style:italic;font-size:12px' href='".$config['base_url']."'>Click here to learn more about ".$config['gmail_name']."</a>.<BR>" .
            "<BR><BR><BR><BR>".
