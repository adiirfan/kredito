    		...
    		case "validation":
    		{
		        ...
		        else
		        {
		            ...
		            if ($return_user != false)
		            {
		            	...
		            	{
		            		$data["pMessage"] = "You're registered as Investor, not a Borrower. Please contact our Support Center";
			                $this->load->view('view_header');
...
;
			...
			case "listproduct":
    		{
				...
				$this->load->model("model_backend");
                $data["loan_list"] = $this->model_credit->view_sumbmission_loan(get_cookie("user_id"));
