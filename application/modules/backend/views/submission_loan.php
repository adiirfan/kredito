            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Pengajuan Pinjaman Marketplace</h3>
				   <div class="row">
					<div class="col-md-3">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
					...
					?>
                     <tr>
						...
						$product =$this->model_backend->select_multiple_loan($row['loan_id']);
						//print_r($product);
						//echo $product[0]['company_product_name'];
						if(isset($product[0]['company_product_name'])){
							foreach ($product as $data){
								echo '- '.$data['company_product_name'].'<br>';
								//echo 'tes'.$product[0]['company_product_name'];
							}
						}else{
							echo $row['company_product_name'];
						}
						?>
						 </td>
