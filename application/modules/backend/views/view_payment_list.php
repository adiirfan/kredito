            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Pembayaran Pinjaman </h3>
				   <div class="row">
					<div class="col-md-3">
					...
					?>
                     <tr>
						...
						<p> <?php echo $row['period']; ?> Bulan</p>
						 ...
						 <td></td>
						  <td>bulan 1 <i class="fa fa-check"></i></td>
						
						<td>
						 <?php 
                        	switch ($row['payment_finish'])
                        	{
                        		case 0: { echo '<span class="label label-danger">Belum Lunas</span>'; break; }
						...
						-->
						<a href="<?php echo base_url(); ?>backend/payment/detail/<?php echo  $row['code'] ?>" class="btn btn-info btn-xs btn-block" >Review</a>
						<?php if($aksi != 0){ ?>
