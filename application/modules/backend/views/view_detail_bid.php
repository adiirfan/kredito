            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Detail Bid dengan Id referensi pinjaman <?php echo $this->uri->segment(4) ?>  </h3>
				   <div class="row">
					<div class="col-md-3">
                ...
                <div class="box-body">
                  <table id="" class="table table-bordered table-striped">
					...
					<?php $z++; }?>
                      <tr>
					  <td colspan="5"><h3 align="center">Total Bid</h3></td><td><h3><?php echo $this->model_backend->rupiah($row['total_bid_amount']); ?></h3></td>
					  </tr>
