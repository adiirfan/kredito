...
<html>
  <head>
    ...
    <title>RajakreditDotCom | Log in</title>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets_backend/plugins/iCheck/square/blue.css">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.html"><b>RAJA</b>KREDIT</a>
      </div><!-- /.login-logo -->
