  ...
  /* Custom filtering function which will search data in column four between two values */
    ...
    $(document).ready(function() {
        ...
        $('#txt_filter').on( 'keyup', function () {
            ...
            save_filter(4001, $('#txt_filter').val(), $('#cbo_filter_status').val());
        });
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Investment by <?php echo $full_name?>
            </h1>
        </div>
    </div>
    <div class="row">
            ...
            <table id="tbl" data-toolbar="#filter-bar" class="table table-striped table-bordered table-hover dt-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>MYR <?php echo number_format($investment_list[$i]->fund_used, 2); ?></td>
