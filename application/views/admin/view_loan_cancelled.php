  ...
  /* Custom filtering function which will search data in column four between two values */
    ...
    $(document).ready(function() {
        ...
        $('#txt_filter').on( 'keyup', function () {
            ...
            save_filter(3005, $('#txt_filter').val());
        });
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Loan - Cancelled
            </h1>
        </div>
    </div>
    <div class="row">
...
<input type="hidden" id="h_menu_id" name="h_menu_id" value="3005">
<input type="hidden" id="h_menu_name" name="h_menu_name" value="cancelled">
</form>