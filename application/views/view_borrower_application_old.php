...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-lg-4 register">
			...
			<p>Suku Bunga per tahun  : 15-20%</p>
			<p>Cicilan perbulan  : {{(((pinjaman/100)*percent)/bulan)+(pinjaman/bulan) | currency:"Rp.":0}} sampai {{(((pinjaman/100)*percentnew)/bulan)+(pinjaman/bulan) | currency:"Rp.":0}}</p>
