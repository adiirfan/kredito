...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4 register">
			<?php echo form_open('investor/login/validation'); ?>
				<?php 
				...
				<br />
				<a href="<?php echo base_url();?>investor/application"> Anda tidak memiliki akun RajaKredit? Klik disini untuk daftar</a>
			<?php echo form_close();?>
		</div>
	</div>
</div>	
