		...
		<?php //echo form_open('borrower/application/next'); ?>
			...
			<div class="row"> 
				...
				<div class="col-lg-6 register">
					...
					<input type="hidden" id="txt_amount" name="txt_amount"  value='<?php echo get_cookie("b_amount") ?>' />
									<input type="hidden" id="txt_period" name="period" value="<?php echo get_cookie("b_month");?>"  maxlength="20" class="form-control group-input" />	
				...
				<!--<input type="text" class="form-control InsuredPrice" data-a-sign="" data-v-min="0" data-v-max="1000000000" data-a-dec="," data-a-sep="." name="txt_company_revenue" id="InsuredPrice" value="<?php //echo $company_revenue; ?>" placeholder="Modal usaha (Rp. .......)" >-->
					...
					?>;">
						<label>KTP</label><input type="file" name="KTP" /><br>
						<label>SIUP</label><input type="file" name="SIUP"/><br>
						<label>NPWP</label><input type="file" name="NPWP"/><br>
					</div>
					<br />
