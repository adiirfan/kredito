...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			<h2>Apply untuk pinjaman anda</h2>
			<hr>
		</div>		
	</div>
	...
	<div class="row">
		<div class="col-lg-4 col-lg-offset-2 register">
			...
			<div class="form-group">
				...
				<?php 
					if (get_cookie("user_id") == "")
						...
						echo form_input('txt_ktp', set_value('txt_ktp', $ktp), 'name="txt_ktp" class="form-control" readonly="true"');
				?>
			</div>
			...
			<div class="form-group">
				<label>Alamat</label>
				<?php echo form_textarea('txt_address', set_value('txt_address', $address), 'name="txt_address" class="form-control"');?>
			</div>
			<div class="form-group">
				<label>Kota</label>
		...
		<div class="col-lg-4 register">
			<h3><!--<i class="fa fa-dollar"></i>-->&nbsp;&nbsp;Informasi Pinjaman</h3>
			...
			<div class="form-group">
				<label>Jumlah Pinjaman</label>
		        		...
		        		<div class="input-group">
							...
							<input type="text" id="txt_amount" name="txt_amount"  ng-model="pinjaman" format="number" maxlength="20" class="form-control group-input" />
						</div>
			...
			<p>Suku Bunga  : 15-20%</p>
			<p>Cicilan perbulan  : {{(((pinjaman/100)*15)/bulan)+(pinjaman/bulan) | currency:"Rp.":0}} sampai {{(((pinjaman/100)*20)/bulan)+(pinjaman/bulan) | currency:"Rp.":0}}</p>
			<p ng-bind="interestrate"></p>
			</div>
			<div class="form-group">
			...
			<br />
			<button name="submit" class="btn btn-info pull-right longer">Next <i class="fa fa-chevron-right"></i></button>
		</div>
	</div>
	<?php echo form_close();?>
</div>	
...
app.controller('customersCtrl', function($scope, $http, $location, $anchorScroll, $locale) {
   ...
   .then(function (response) {$scope.names = response.data.records;});
    $scope.pinjaman = '<?php echo get_cookie("b_amount")?>';
	 $scope.months = ['1','2','3','4','5','10','15','18','25'];
	 $scope.selected = 0;
	  $scope.bunga=20/100;
	   $scope.bulan=<?php echo get_cookie("b_month")?>*12;
