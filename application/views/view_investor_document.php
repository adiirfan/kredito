...
<div class="container">
    <div class="row">
		...
		<br>
            <h2 style="text-align:center;">Anda harus mengupload dokumen untuk melakukan Pendanaan</h2>
            <hr>
        </div>      
    </div>
    ...
    <form id="fileupload-pa" action="upload" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 register">
                <div class="row fileupload-buttonbar">
                    <div class="col-lg-12" style="display:inline-block">
                        <p id="lbl_message_pa" class="alert alert-danger hidden">Silahkan upload scan form perjanjuan</p>
                        <h4>Silahkan upload form perjanjian (Download disini)</h4>
                        <span class="btn btn-success fileinput-button longer">
                            <span>Tambah File</span>
                            <i class="glyphicon glyphicon-plus"></i>
                            <input type="file" name="files[]" multiple>
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <a href="<?php echo base_url(); ?>investor/application" class="btn btn-info" style="margin-bottom:5px"><i class="fa fa-chevron-left"></i> Kembali</a>
            <button id="btn_submit" name="btn_submit" onclick="return form_submit();" class="btn btn-info pull-right" style="margin-right:5px;margin-bottom:5px">Upload <i class="fa fa-chevron-right"></i></button>
