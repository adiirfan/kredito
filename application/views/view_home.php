          ...
          <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-sm-12 div-center">
                    <a class="btn btn-info btn-lg btn-outline" href="<?php echo base_url();?>investor/application">Lakukan Pendanaan</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-section-a">
          ...
          <div class="container">
            <div class="row">
                ...
                <br />
                <div class="col-lg-12 col-sm-12 div-center">
                    <a class="btn btn-info btn-lg btn-outline" href="<?php echo base_url();?>security/register">Daftar Sekarang</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                    <div class="div-center">
                        <hr class="section-heading-spacer">
                        <div class="clearfix"></div>
                        <h2 class="section-heading">Marketplace Kredito</h2>
                    </div>
                    <div class="row">
