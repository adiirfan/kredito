        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-sm-pull-6  col-sm-6 col-xs-12" style=" margin-top: 50px; margin-bottom: 25px; padding:10px 10px 10px 10px;">
					...
					<form  action="<?php echo base_url();?>pilihan" method="post" enctype="multipart/form-data">
					<font color="#fff">
					...
					<option value="Perusahaan">Perusahaan</option>
						...
						<select onchange="getTenor(this.value);" name="tujuan" id="tujuan" class="form-control">
						...
						<div onload="getTenor();" id="testing">
						...
						<!--
							...
							<div class="col-sm-12 text-center"> 
									...
									<input type="hidden" id="h_tenor" name="h_tenor" value="tes"/>
...
function getTenor(pinjaman) {
  ...
  xhttp.open("GET", "<?php echo base_url(); ?>"+"pinjaman/tenor/?pinjaman="+pinjaman, true);
  xhttp.send();
}
</script>
