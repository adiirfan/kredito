...
<script>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <!--
                        <h4>Loans funded to date: MYR <?php echo number_format($total_investment_used, 0); ?></h4>
                        -->
                    </div>
                </div>
            </div>
    ...
    <div id="popup">
        ...
        <div class="row">
       	...
       	<br />
       	<h5>Berapa lama periode pembayaran?</h5>
		...
		<div class="col-sm-12 text-center"> 
            <form id="apply-form-1" action="<?php echo base_url();?>borrower/option" method="post" accept-charset="UTF-8">
                <button name="submit" class="btn btn-info center-block longer">Apply</button>
            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 col-sm-12">
                    <div class="div-center">
						...
						<!--
						<form method="post" action="security/login/check">
						<div class="input-group">
