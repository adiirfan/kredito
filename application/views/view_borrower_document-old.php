...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            As part of our process of verifying and to know our customer, we need some docments from you. Please note that all documents are kept safely under our <a>privacy policy</a>.
            <hr>
        </div>      
    </div>
            ...
            <div class="col-lg-8 col-lg-offset-2 register">
                <div class="row fileupload-buttonbar">
                    <div class="col-lg-12" style="display:inline-block">
                        <p id="lbl_message_aa" class="alert alert-danger hidden">Please upload Audited Accounts</p>
                        <h4>Audited Accounts - <span class="small">Full set of audited accounts and/or latest management account (Minimum 2 years).</span></h4>
    ...
    <form id="fileupload-ma" action="upload" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 register">
                <div class="row fileupload-buttonbar">
                    <div class="col-lg-12" style="display:inline-block">
                        <p id="lbl_message_ma" class="alert alert-danger hidden">Please Upload M & A</p>
                        <h4>M & A</h4>
                        <span class="btn btn-success fileinput-button longer">
                            <span>Add Files</span>
                            <i class="glyphicon glyphicon-plus"></i>
    ...
    <form id="fileupload-la" action="upload" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 register">
                <div class="row fileupload-buttonbar">
                    <div class="col-lg-12" style="display:inline-block">
                        <p id="lbl_message_la" class="alert alert-danger hidden">Please upload Letter of Award</p>
                        <h4>Letter of Award - <span class="small">For project financing</span></h4>
                        <span class="btn btn-success fileinput-button longer">
                            <span>Add Files</span>
                            <i class="glyphicon glyphicon-plus"></i>
                            <input type="file" name="files[]" multiple>
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            ...
            <a href="<?php echo base_url(); ?>borrower/application" class="btn btn-info" style="margin-bottom:5px"><i class="fa fa-chevron-left"></i> Back</a>
            <button id="btn_submit" name="btn_submit" onclick="return form_submit();" class="btn btn-info pull-right" style="margin-right:5px;margin-bottom:5px">Submit Now <i class="fa fa-chevron-right"></i></button>
            <button id="btn_save" name="btn_save" onclick="form_save();" class="btn btn-info pull-right" style="margin-right:5px;margin-bottom:5px">Save & Submit Later </button>
