				  ...
				  <modal title="Dapatkan Produk Keuangan Terbaik untuk Anda" visible="showModal">
				   <div class="modal-content" >
				    <div class="modal-header">
					  ...
					  <h4 align="center" class="modal-title">Dapatkan Produk Keuangan Terbaik untuk Anda</h4>
					</div>
				...
				<div class="container">
				  ...
				  <div class="modal-content" >
				    <div class="modal-header">
					  ...
					  <h4 align="center" class="modal-title">Sumit pengajuan anda</h4>
					</div>
						...
						<form role="form" name="userForm" ng-submit="submitRegister()">
							...
							<div class="row">
							 <div class="col-md-2">
							  ...
							  <div class="col-md-8">
							  <br>
							 <div class="alert alert-danger" ng-hide="alert"><button data-dismiss="alert" class="close">&times;</button><i class="fa fa-times-circle"></i><strong>Maaf! </strong>{{alert_info}} harus diisi </div>
							  <div class="form-group">
					...
					<form role="form">
						<div class="row">
						 <div class="col-md-2">
						  ...
						  <div class="col-md-8">
							<h2 align="center"> <img src="<?php echo base_url(); ?>assets/img/loading_product.gif" > </h2>
						  </div>
						  <div class="col-md-2">
						 </div>
						</div>
	...
	$scope.names1 = name.interest_rate;
	 ...
	 $scope.submitForm = function() {
		...
		$scope.submitRegister = function() {
		 ...
		 // $scope.Modalregister = false;
		 if(typeof $scope.reg.nama == "undefined"){
			$scope.alert = false;
			$scope.alert_info = "Nama Lengkap";
			return;
		 }
		 if(typeof $scope.reg.telp == "undefined"){
			$scope.alert = false;
			$scope.alert_info = "Nomor telepon";
			return;
		 }
		 if(typeof $scope.reg.email == "undefined"){
			$scope.alert = false;
			$scope.alert_info = "Email";
			return;
		 }
		 if(typeof $scope.reg.income == "undefined"){
			$scope.alert = false;
			$scope.alert_info = "Pendapatan per-bulan";
			 return;
		 }
		 ...
		 //role modal hide
		  $scope.ajukan = true;
		  $scope.Modalregister = false;
		  $scope.Modalloading = !$scope.Modalloading;
 ...
 //   }
   ...
   .then(function (response) {$scope.names = response.data.records;});
	...
	app.directive('modal', function () {
		return {
		template: '<div class="modal fade" id="modal-2" data-backdrop="static" data-keyboard="false">' + 
