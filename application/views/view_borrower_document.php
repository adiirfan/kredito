    ...
    <form id="fileupload-la" action="upload" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 register">
                <div class="row fileupload-buttonbar">
                    <div class="col-lg-12" style="display:inline-block">
                        <p id="lbl_message_la" class="alert alert-danger hidden">Silahkan upload duokumen pribadi anda</p>
                        <h4>Dokumen pribadi (Sertifikat Perhiasan/sertifikat jabatan/surat keterangan kerja) <span class="small"></span></h4>
                        <span class="btn btn-success fileinput-button longer">
                            <span>Tambah File</span>
                            <i class="glyphicon glyphicon-plus"></i>
                            <input type="file" name="files[]" multiple>
